...
\begin{table}[h]
  ...
  \begin{tabular}{c c c c c c c c c c c}
    \toprule
      ...
      B & 1 & 2\sfrac{1}{2} + 2\sfrac{1}{2} = 5 & 1 & 6 & \phantom{0}4 & 3 & 12           & \phantom{0}2 & \phantom{0}6 & 120\% \\ % ця мітка у заголовку \\
...
в 2\sfrac{1}{2} ф. стерл. на акр було вкладено в другі акри земель $B$, $C$ і $D$.
