...
\noindent{}Весь оборот обчисляється так:
\begin{table}[H]
  \centering
  \begin{tabular}{r@{~}l@{~}l@{~}l}
  Капітал \phantom{II}І & \deq{} 300\pound{ф. стерл.} & × 5\tbfrac{2}{3} 
  & \deq{} 1700\pound{ ф. стерл.} \\

  \ditto{Капітал} \phantom{I}II & \deq{} 300 \ditto{\pound{ф. стерл.}} & × 5\tbfrac{1}{3} & \deq{} 1600\pound{ ф. стерл.} \\
 
  \ditto{Капітал} III & \deq{} 300\ditto{\pound{ф. стерл.}} & × 5 & \deq{} 1500\pound{ ф. стерл.} \\
  \midrule
  Ввесь капітал & \phantom{\deq{}} 900\ditto{\pound{ф. стерл.}} & × 5\tbfrac{1}{3} & \deq{} 4800\pound{ ф. стерл.}\\
  \end{tabular}
\end{table}
